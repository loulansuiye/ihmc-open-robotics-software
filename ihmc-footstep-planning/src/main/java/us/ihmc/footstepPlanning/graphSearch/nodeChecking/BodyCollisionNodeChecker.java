...
public class BodyCollisionNodeChecker extends FootstepNodeChecker
{
   ...
   public boolean isNodeValid(FootstepNode node, FootstepNode previousNode)
   {
      ...
      {
         notifyPlannerListenerThatNodeIsRejected(node, previousNode, BipedalFootstepPlannerNodeRejectionReason.OBSTACLE_HITTING_BODY);
         return false;
      }
   ...
   {
      listeners.parallelStream().forEach(listener -> listener.nodeUnderConsiderationWasRejected(node, parentNode, rejectionReason));
   }
}
